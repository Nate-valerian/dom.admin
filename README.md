🏛️ DOM Admin Panel
A modern, bilingual (English/Russian) admin dashboard for managing users, products, events, groups, and semantic memory. Built with React and designed for the DOM ecosystem.
